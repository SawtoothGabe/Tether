...
namespace Tether::Rendering::Vulkan
{
	GraphicsContext::GraphicsContext(
		...
		const InstanceLoader& instanceLoader,
		const DeviceLoader& deviceLoader,
		VkInstance instance,
	...
	GraphicsContext::GraphicsContext(const ContextCreator& vulkanContext)
		:
	...
	{
#ifdef TETHER_HEADLESS
	    throw std::logic_error("Cannot create window render target with TETHER_HEADLESS");
#else
